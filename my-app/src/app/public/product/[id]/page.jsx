...
export default function ProductView({ params }) {
  ...
  const handleAddComment = (e) => {
    ...
    setComments([...comments, { user: "You", comment }]);
    setComment("");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-8 w-full felx justify-center">
      <div className="w-full mx-auto bg-white rounded-2xl shadow p-6 md:p-10 lg:w-[90%] relative">
        <button onClick={() => router.push('/public')} className="p-1 hover:bg-gray-100 rounded-full absolute top-5" ><Image className="w-[27px] md:w-[35px] lg:w-[33px]" src={back_icon} alt="back_icon" /></button>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500">⭐/ 5.0 (200+ reviews)</p>
            ...
            {!existItemInCart ?
              ...
              : <div className="mt-6 flex gap-3">
                <button onClick={() => handleAddToCart()} className="flex-1 rounded-full bg-[green] text-white py-3 font-medium hover:bg-[green]-700">
                  Added to Cart
                </button>
                <button className="flex-1 rounded-full border border-indigo-600 text-indigo-600 py-3 font-medium hover:bg-indigo-50">
                  View Cart
